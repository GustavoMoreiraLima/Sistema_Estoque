...
include __DIR__ . "/../view_editar.php"
...
<div class="container">
    ...
    <form id="product-form" method="POST">
        ...
        <input type="text" id="product-name" name="nome" value="<?php echo $nome?>" required>

        <!-- Tipo de Unidade -->
        <label for="unit-type">Tipo de Unidade:</label>
        <input type="text" id="unit-type" name="tipo" value="<?php echo $tipo?>" required>

        <!-- Referência -->
        <label for="reference">Referência:</label>
        <input type="text" id="reference" name="referencia" value="<?php echo $referencia?>" required>
